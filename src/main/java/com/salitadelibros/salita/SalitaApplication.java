...
/*
	...
	public CommandLineRunner initData(LibroRepositorio libroRepositorio,
		...
		return (args -> {
			...
			Ilustrador ilustrador4 = new Ilustrador("Caterina", "Di Mauro");
			Ilustrador ilustrador5 = new Ilustrador("Lourdes", "Pereyra");
			Ilustrador ilustrador6 = new Ilustrador("Abril", "Di Mauro");
			Ilustrador ilustrador7 = new Ilustrador("Lilo", "Fernandez");
			Ilustrador ilustrador8 = new Ilustrador("Alberto", "Pereyra");
			Ilustrador ilustrador9 = new Ilustrador("Quique", "Di Mauro");
			Ilustrador ilustrador10 = new Ilustrador("Daniel", "Fernandez");
			Ilustrador ilustrador11 = new Ilustrador("Adrian", "Pereyra");
			Ilustrador ilustrador12 = new Ilustrador("Valentina", "Di Mauro");
			ilustradorRepositorio.save(ilustrador1);
			ilustradorRepositorio.save(ilustrador2);
			ilustradorRepositorio.save(ilustrador3);
			ilustradorRepositorio.save(ilustrador4);
			ilustradorRepositorio.save(ilustrador5);
			ilustradorRepositorio.save(ilustrador6);
			ilustradorRepositorio.save(ilustrador7);
			ilustradorRepositorio.save(ilustrador8);
			ilustradorRepositorio.save(ilustrador9);
			ilustradorRepositorio.save(ilustrador10);
			ilustradorRepositorio.save(ilustrador11);
			ilustradorRepositorio.save(ilustrador12);
			...
			Categoria categoria11 = new Categoria("matemática");
			Categoria categoria12 = new Categoria("Lluvia");
			Categoria categoria13 = new Categoria("divulgacion cientifica");
			...
			categoriaRepositorio.save(categoria11);
			categoriaRepositorio.save(categoria12);
			categoriaRepositorio.save(categoria13);
